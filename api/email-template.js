...
export function buildEmailTemplate({ name, email, platforms, issue, message, attachmentsCount, timestamp }) {
  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <div class="meta">
        ...
        <div class="meta-row">
          <span class="meta-label">Източник</span>
          <span class="meta-value">Онлайн форма</span>
        </div>
      </div>

      <!-- CTA -->
      <div class="cta-wrapper">
        <a href="mailto:${encodeURIComponent(email)}?subject=${encodeURIComponent('Re: Запитване Unban Solutions')}&amp;body=${encodeURIComponent(`Здравейте ${name},\r\n\r\nБлагодарим за запитването!\r\n\r\n`)}" class="cta-button">
          Отговори на клиента →
        </a>
      </div>
