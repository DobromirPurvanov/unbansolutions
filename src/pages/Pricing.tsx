  ...
  return (
    <>
      <SEOMeta
        ...
        description={isBg ? 'Ясни цени за консултация, оценка и подготовка на казуси, без обещание за решение от платформата. Вижте какво включва всяка услуга.' : 'Clear prices for consultation, assessment and case preparation, without promising a platform decision. See what each service includes.'}
