...
export default function BlogPost() {
  ...
  const articleSchema = useMemo(() => post ? {
    ...
    mainEntityOfPage: `https://www.unbansolutions.com/blog/${post.slug}`,
    image: 'https://www.unbansolutions.com/icon-512.png',
    author: { '@type': 'Organization', '@id': 'https://www.unbansolutions.com/#organization', name: 'Unban Solutions' },
    publisher: { '@type': 'Organization', '@id': 'https://www.unbansolutions.com/#organization', name: 'Unban Solutions' },
    inLanguage: 'bg',
  } : undefined, [post]);
  ...
  if (!post) {
    return (
      <main className="min-h-[60vh] flex items-center justify-center">
        <SEOMeta title={isBg ? 'Статията не е намерена | Unban Solutions' : 'Article not found | Unban Solutions'} noindex />
